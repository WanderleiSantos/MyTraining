...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231015022338_RenameColumnsPlanningExercises")]
    partial class RenameColumnsPlanningExercises
    {
            ...
            modelBuilder.Entity("planning_exercises", b =>
                {
                    ...
                    b.Property<Guid>("series_planning_id")
                        .HasColumnType("uuid");

                    b.HasKey("exercise_id", "series_planning_id");

                    b.HasIndex("series_planning_id");
            ...
            modelBuilder.Entity("planning_exercises", b =>
                {
                    ...
                    b.HasOne("Core.Entities.SeriesPlanning", null)
                        .WithMany()
                        .HasForeignKey("series_planning_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
