...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231014212401_UpdatedTablePlanningExercisesKeyMapping")]
    partial class UpdatedTablePlanningExercisesKeyMapping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("planning_exercises", b =>
                {
                    b.Property<Guid>("ExercisesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SeriesPlanningsId")
                        .HasColumnType("uuid");

                    b.HasKey("ExercisesId", "SeriesPlanningsId");

                    b.HasIndex("SeriesPlanningsId");

                    b.ToTable("planning_exercises");
                });
            ...
            modelBuilder.Entity("planning_exercises", b =>
                {
                    ...
                    b.HasOne("Core.Entities.SeriesPlanning", null)
                        .WithMany()
                        .HasForeignKey("SeriesPlanningsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
